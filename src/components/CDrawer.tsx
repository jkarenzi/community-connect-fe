    ...
    return (
        <div className="flex flex-col w-[25%] bg-white border-r border-[lightgray] items-center justify-between">     
            <div className="flex flex-col items-center w-full mt-6">
                ...
                <Link to='/' className={`pl-4 py-4 ${location.pathname === '/' ? 'bg-custom-darkRed text-white hover:bg-custom-black': 'hover:bg-[#f2f2f2]'} w-[92%] flex items-center justify-start gap-4 rounded-lg`}>
                    <MdHomeRepairService size={17} color={location.pathname === '/' ? 'white': 'black'}/>
                    <h2>Services</h2>
                </Link>
            ...
            {user && <div className="flex flex-col gap-4 items-center w-[90%] rounded-md hover:bg-[#eaeaea] p-4 mb-4 cursor-pointer" onClick={() => dispatch(logout())}>
